...
NeoBundle 'hashivim/vim-terraform' " Terraform development
NeoBundle 'hashivim/vim-packer' " Packer development
NeoBundle 'hashivim/vim-vagrant' " Vagrant development
NeoBundle 'andrewstuart/vim-kubernetes' " Kubernetes development
